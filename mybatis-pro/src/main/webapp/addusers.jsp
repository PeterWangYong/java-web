...
<div class="container">
    <div class="row">
        <div class="page-header">
            <h1>后台管理系统<small>用户管理中心</small></h1>
        </div>
    </div>
    <div class="row">
        <div class="jumbotron">
            ...
            <p><a href="#" class="btn btn-primary btn-lg" role="button">点击查看更多</a></p>
        </div>
    </div>
        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/addusers">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="userpass" name="userpass" placeholder="请输入登录密码">
                    </div>
                </div>
                <div class="form-group">
